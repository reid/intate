...
get("/api/friends", function () {
    var express = this;
    if (!this.session.token) express.respond(403, "Authorization required");
...
get("/static/*.js", function (file) {
    this.sendfile(path + "/js/" + file + ".js", {"encoding" : "ascii"});
});
